...
# Add keys partition
/dev/sda3 : start=$keys_start, size=$keys_sectors, type=EBD0A0A2-B9E5-4433-87C0-68B6B72699C7, name="Keys"

# Add data partition
/dev/sda4 : start=$data_start, type=0FC63DAF-8483-4772-8E79-3D69D8477DE4, name="Data"
